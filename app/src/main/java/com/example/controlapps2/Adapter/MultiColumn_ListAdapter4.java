...
public class MultiColumn_ListAdapter4 extends ArrayAdapter<User4> {

    private LayoutInflater mInflater;
    private ArrayList<User4> users;
    private int mViewResourcId;

    public MultiColumn_ListAdapter4(Context context, int textViewResourceId, ArrayList<User4> users){
