...
public class MultiColumn_ListAdapter3 extends ArrayAdapter<User3> {

    private LayoutInflater mInflater;
    private ArrayList<User3> users;
    private int mViewResourcId;

    public MultiColumn_ListAdapter3(Context context, int textViewResourceId, ArrayList<User3> users){
