...
public class MultiColumn_ListAdapter2 extends ArrayAdapter<User2> {

    private LayoutInflater mInflater;
    private ArrayList<User2> users;
    private int mViewResourcId;

    public MultiColumn_ListAdapter2(Context context, int textViewResourceId, ArrayList<User2> users){
